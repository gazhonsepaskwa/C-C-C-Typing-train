...
function randomWords(diff){
  ...
  basicWords = [
    ...
    "int", "float", "double", "char", "void", "bool", "short", "long", "signed", "unsigned",

    "if", "else", "while", "for", "return", "switch", "case", "break", "continue",

    "void", "return", "static", "extern", "const", "volatile", "sizeof",

    "printf", "scanf", "fgets", "strlen", "strcpy", "malloc", "free", "exit", "abort",

    "main", "argc", "argv", "NULL", "true", "false", "index", "array", "ptr", "i", "j", "k", 
    "n", "m", "len", "buf", "str", "char", "num", "count", "sum"
  ]

  topWords = [
    "~", "?", ":", "::", "->",

    "wchar_t", "size_t", "ssize_t", "uintptr_t", "intptr_t",

    "do", "goto",

    "inline", "typedef", "register", "auto", "restrict",

    "namespace", "class", "public", "private", "protected", "friend", "virtual",
    "this", "new", "delete", "operator", "template", "typename", "using", 
    "try", "catch", "throw", "const_cast", "dynamic_cast", "reinterpret_cast", "static_cast",

    "using", "interface", "public", "private", "protected", "internal", "override",
    "new", "abstract", "sealed", "static", "readonly", "event", "delegate", "base",
    "typeof", "sizeof", "is", "as", "ref", "out", "params", "in", "lock", "try",
    "catch", "finally", "checked", "unchecked", "unsafe", "fixed", "stackalloc",
    "async", "await", "yield", "get", "set", "add", "remove", "var", "dynamic",

    "strncpy", "strcmp", "strcat", "calloc", "realloc", "system", "atof", "atoi",
    "atol", "strtol", "strtod", "rand", "srand", "qsort", "bsearch", "memcpy",
    "memset", "fopen", "fclose", "fread", "fwrite", "fseek", "ftell", "rewind",
    "fgetc", "fputc", "fprintf", "fscanf", "getchar", "putchar", "perror", "assert", 
    "time", "clock", "difftime", "mktime", "localtime", "gmtime", "strftime",

    "tmp", "result", "flag", "value", "key", "object", "args", "param", "args", 
    "data", "element", "node", "list", "queue", "stack", "tree", "graph", "map", "set",

    "noexcept", "constexpr", "override", "final", "nullptr", "decltype",

    "get", "set", "add", "remove", "var", "dynamic", "default", "nameof",

    "mutex", "lock_guard", "unique_lock", "thread", "future", "promise", 
    "shared_ptr", "unique_ptr", "iterator", "vector", "deque", "strncpy",
    "ssize_t", "uintptr_t", "intptr_t", "qsort", "bsearch"
  ]
